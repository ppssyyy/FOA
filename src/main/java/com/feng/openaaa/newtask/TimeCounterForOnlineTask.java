...
import com.feng.openaaa.newtask.observable.TimeCounterForOnlineTaskObservable;
...
public class TimeCounterForOnlineTask extends Task<Void> implements TimeCounterForOnlineTaskObservable{
	...
	protected Void call() throws Exception {
		...
		while(true){
			...
			updateOnelineTime(hourString+time1);
	...
	@Override
	public void updateOnelineTime(String time) {
