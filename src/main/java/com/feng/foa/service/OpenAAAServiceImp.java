...
/**
 * OpenAAAService的实现类。利用OpenAAA API实现。当前OpenAAA API版本为
 * 1.0.0.0。
 * 
 * @author fengyouchao
 * @version 1.0
...
public class OpenAAAServiceImp implements OpenAAAService{
	...
	@Override
	public boolean isAPINeedUpdate() throws ConnectServerFailedException {
	 ...
	 * @return <code>LoginResultInfo</code>对象。
	 */
